...
class AssignmentViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, FUIIndexArrayDelegate {
    ...
    internal func fetchMembers(for _: Assignment) {
        guard let topic = self.topic else { return }
    ...
    internal func array(_: FUIIndexArray, reference _: FIRDatabaseReference, didLoadObject object: FIRDataSnapshot, at _: UInt) {
